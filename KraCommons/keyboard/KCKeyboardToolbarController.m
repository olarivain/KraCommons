...
- (void)moveKeyboardToolbar:(CGRect)keyboardRect withDuration:(NSTimeInterval)duration keyboardVisible:(BOOL) keyboardVisible;
...
- (void)keyboardWillShow: (NSNotification*) notification {
    ...
    //[self resizeViewForKeyboard:keyboardRect keyboardVisible:TRUE];
